    ...
    <div className="relative flex items-center justify-center overflow-hidden">
      {imageError ? (
        ...
        <img
          ...
          style={{ transform: `scale(${zoom})`, maxHeight: isFullscreen ? '80vh' : '200px' }}
      ...
      <div className="rounded-lg border border-[var(--color-border)] bg-surface p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() => { setIsFullscreen(true); handleResetZoom(); }}
              className="rounded p-1 text-text-muted hover:text-white hover:bg-surface-hover transition-colors"
              title="Fullscreen"
            >
        ...
        {/* Preview */}
        <div className="rounded-md bg-surface-elevated border border-[var(--color-border)] overflow-hidden">
          {previewContent}
        </div>
      </div>
      ...
      {isFullscreen && (
        ...
        >
          ...
          >
            ...
            {imageError ? (
              <div className="flex items-center justify-center bg-surface-elevated p-12 rounded-lg">
                <p className="text-text-muted">Failed to load screenshot</p>
              </div>
            ) : (
              <img
                src={imageUrl}
